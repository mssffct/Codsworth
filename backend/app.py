...
from db_utils import create_trash_collector
from config import API_PORT, API_HOST, codsworth_openapi_config, DB_URI
...
app = Litestar(
    ...
    on_app_init=[jwt_cookie_auth.on_app_init, lambda app: create_trash_collector(app)],
    exception_handlers={
